...
export default function Index() {
  ...
  const handleMySchemePress = () => {
    router.push("/mySchemes"); // Replace 'MyScheme' with your actual screen name
  };

  const handleJoinSchemePress = () => {
    router.push("/joinSchemes"); // Replace 'JoinScheme' with your actual screen name
  };

  const paymentPage = () => {
    router.push("/(root)/(tabs)/payment"); // Replace 'JoinScheme' with your actual screen name
  };

  const supportPage = () => {
    router.push("/(root)/(tabs)/support"); // Replace 'JoinScheme' with your actual screen name
  };

  const privacyPolicy = () => {
    router.push("/Privacy"); // Replace 'JoinScheme' with your actual screen name
  };
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      {/* Side Navigation Menu code remains the same */}
      <Animated.View 
        style={{
        ...
        <View className="w-[178px] h-[99px] bg-white rounded-lg shadow-lg p-4 border border-gray-200">
          <View className="flex-row items-start justify-between">
            ...
            <View className="items-end">
              ...
              <Text className="text-2xl font-rubik-medium text-primary-100">₹58,750</Text>
            </View>
          </View>
        ...
        <View className="w-[178px] h-[99px] bg-white rounded-lg shadow-lg p-4 border border-gray-200">
          <View className="flex-row items-start justify-between">
            ...
            <View className="items-end">
              ...
              <Text className="text-2xl font-rubik-medium text-accent-100">₹60,250</Text>
            </View>
          </View>

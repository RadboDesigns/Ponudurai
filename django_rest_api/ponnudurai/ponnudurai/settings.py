"""
Django settings for ponnudurai project.
...
MIDDLEWARE = [
    ...
    'goldLoan.middleware.RoleBasedAccessMiddleware',
]
...
WSGI_APPLICATION = 'ponnudurai.wsgi.application'
...
STATIC_URL = '/static/'  # Note: no 'app/' prefix here
